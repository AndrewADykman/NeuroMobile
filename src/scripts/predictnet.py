...
class Predictor:
	...
	#sequence of 5 of 250x250x3 images
	input_size = (5, 250, 250, 3)
	#take in a sequence of images
        ...
        maxpool_flat = tf.expand_dims(tf.reshape(maxpool5, [-1]), 0)
        ...
        self.prediction = tf.nn.softmax(tf.matmul(fc6, y_W) + y_B)
